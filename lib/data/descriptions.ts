...
export const TITHIS: Record<string, TithiScore> = {
  ...
  'Shukla Dwadashi':     T('Bhadra', 'Stability',    'Exceptional for agreements, institutional dealings, banking, financial activities, and long-term stability.',             tc('Excellent', 90), tc('Excellent', 98),  tc('Very Good', 89), tc('Excellent', 100),tc('Excellent', 100)),
  ...
  Purnima:               T('Purna',  'Fulfillment',  'Best suited for fulfillment, settlements, completion, realization, and closing successful negotiations.',                tc('Very Good', 84), tc('Very Good', 86),  tc('Excellent', 90), tc('Very Good', 90), tc('Very Good', 88)),
  ...
  'Krishna Dwitiya':     T('Bhadra', 'Cooperation',  'Supports partnerships, continuity, cooperation, and stable financial dealings.',                                         tc('Very Good', 84), tc('Excellent', 90),  tc('Excellent', 85), tc('Excellent', 95), tc('Excellent', 92)),
  ...
  'Krishna Shashthi':    T('Nanda',  'Achievement',  'Good for administration, operational management, compliance, and internal business matters.',                            tc('Very Good', 81), tc('Very Good', 80),  tc('Very Good', 82), tc('Very Good', 80), tc('Very Good', 80)),
